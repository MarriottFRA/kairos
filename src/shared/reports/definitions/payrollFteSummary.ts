...
export const PAYROLL_FTE_SUMMARY = defineReport({
  ...
  rows: [
    ...
    spacer(),
    header("ROOMS"),
    line("rooms_res_payroll_line", "Total Rooms & Reservations Payroll", 1),
    line("rooms_payroll_line", "Total Rooms Payroll", 1),
    line("rooms_sold_line", "Sold Rooms", 1),
    line("rooms_payroll_por", "Rooms Payroll POR", 1),
    spacer(),
    header("FOOD & BEVERAGE"),
    line("fb_payroll_line", "Total F&B Payroll", 1),
    line("fb_payroll_pct_fb_revenue", "F&B Payroll as % of F&B Revenue", 1),
    line("restaurant_payroll_line", "Total Restaurant Payroll", 1),
    line("lounge_payroll_line", "Total Lounge Payroll", 1),
    line("banquet_payroll_line", "Total Banquet Payroll", 1),
    line("room_service_payroll_line", "Total Room Service & Mini Bar Payroll", 1),
    line("kitchen_payroll_line", "Total Kitchen Payroll", 1),
    spacer(),
    header("OTHER DEPARTMENTS"),
    line("ag_payroll_line", "Total Admin & General Payroll", 1),
    line("it_payroll_line", "Total IT & Telephone Payroll", 1),
    line("pom_payroll_line", "Total POM Payroll", 1),
    line("sm_payroll_line", "Total Sales & Marketing Payroll", 1),
    line("other_ops_payroll_line", "Total Other Operations Payroll", 1),
  ],
});
